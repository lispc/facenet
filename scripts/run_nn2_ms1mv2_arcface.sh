#!/usr/bin/env bash
# ArcFace controlled experiment: same data / model / optimizer / LR / batch as the
# previous semi-hard resume, only the loss is changed to ArcFace.
set -euo pipefail

OUTPUT_DIR="./checkpoints/nn2_ms1mv2_lmdb_p64k16_arcface"
mkdir -p "${OUTPUT_DIR}"
