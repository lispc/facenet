...
# 与 run_resnet100_ms1mv2_arcface_scratch.sh 唯一区别：
# - 使用 --accum_steps 4 把 effective global batch 从 1024 提升到 4096
# - lr 从 1e-3 提升到 4e-3（linear scaling）
set -euo pipefail

OUTPUT_DIR="./checkpoints/resnet100_ms1mv2_lmdb_p32k8_accum4_arcface"
mkdir -p "${OUTPUT_DIR}"
